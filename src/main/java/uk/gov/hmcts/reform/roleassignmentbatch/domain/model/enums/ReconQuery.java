...
public enum ReconQuery {
    ...
    GROUP_BY_CCD_JURISDICTION("select jurisdiction,count(1) from ccd_user_view group"
                              + " by jurisdiction order by jurisdiction"),
    ...
    GROUP_BY_AM_JURISDICTION("select attributes->>'jurisdiction' as caseType,count(1)"
