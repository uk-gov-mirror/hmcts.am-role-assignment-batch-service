...
public class Constants {
    public final String REQUEST_QUERY = "INSERT INTO role_assignment_request "
            + "(id, correlation_id,client_id,authenticated_user_id,assigner_id,request_type,status,"
            + "process,reference,"
            ...
            + ":replaceExisting,:roleAssignmentId,:log,:created)";
}
